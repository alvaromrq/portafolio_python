...
print(f'\nNombre empresa: {nombre_empresa}') # Introducimos \n para imprimir en una nueva linea
...
nombre_empresa_normalizado = nombre_empresa.replace(' ', '').lower() # Eliminamos los espacios con replace, reemplazando espacios " " por nada "", en la misma linea convertimos a minusculas con .lower
dominio_email_normalizado = f'@{nombre_empresa_normalizado}{extension_dominio}' # Con una cadena f, añadimos @ y las variables generadas
